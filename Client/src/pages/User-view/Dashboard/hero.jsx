...
const Hero = () => {
  ...
  return (
    <section className="h-full  !-mt-16 overflow-hidden">
      {/* <div
        className={` bg-[url('http://res.cloudinary.com/dulkmeadg/image/upload/v1730526219/e7l6eu9absgauzh6pi9c.jpg')] 2xl:h-[600px] xl:h-[600px] lg:h-[500px] md:h-[450px] sm:h-[450px] h-[450px] bg-cover bg-top`}
      > */}

    ...
    <section className="h-full  !-mt-16 overflow-hidden">
      ...
      >
        <div className="hero-Back">
          <div className="mx-auto  2xl:h-[600px] xl:h-[600px] lg:h-[500px] md:h-[450px] pt-20 pb-3 sm:h-[450px] h-[450px]    flex flex-col justify-between  ">
            <div id="Conten" className="text-center">
              <motion.h1
                ...
                className={`bebas-neue-regular bg-gradient-to-t from-[#ffae00] to-[#fff9ee] bg-clip-text text-transparent font-bold text-shadow lg:text-[6vw] xl:text-[6vw] 2xl:text-[6vw] sm:text-[7vw] text-[8.5vw] w-full`}
              >
